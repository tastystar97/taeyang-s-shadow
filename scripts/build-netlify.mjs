...
const allowed = ['index.html','control.html','app.js','control.js','styles.css','archive-editor.js','login-sequence.js','session-guard.js','personnel-control.js','archive-control.js','form-templates.js','workflow-control.js','cases-ui.js','number-templates.js'];
