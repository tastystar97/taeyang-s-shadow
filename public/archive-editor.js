const SIGNATURE = { name: '최영호', image: '/media/signatures/choi-youngho.png' };
...
if (schema) {
  ...
  style.textContent = `
    ...
    .ugn-signature-slot{position:relative!important;min-height:78px!important;outline:none}.ugn-signature-control{position:absolute;inset:22px 5px 4px;display:grid;place-items:center;border:1px dashed #7e98a7;background:rgba(255,255,255,.78);color:#4c6a79;font:700 .62rem/1.35 Consolas,monospace;text-align:center;cursor:pointer;overflow:hidden}.ugn-signature-control:hover{border-color:#137698;background:#eef9fb}.ugn-signature-control img{width:100%;height:100%;object-fit:contain;filter:none}.ugn-signature-control.signed{border-style:solid;border-color:#567f91;background:#fff}.ugn-signature-control.signed::after{content:'전자서명 · 최영호';position:absolute;right:4px;bottom:2px;color:#406476;background:#ffffffd9;font:700 .48rem Consolas,monospace}
    ...
    .ugn-reply-fields{display:grid;grid-template-columns:1fr 170px;gap:10px;margin-top:9px;padding-top:9px;border-top:1px solid #9fb0bc}.ugn-reply-fields label{display:grid;gap:5px;color:#566f7f;font:800 .58rem Consolas,monospace}.ugn-reply-fields textarea{width:100%;min-height:58px;padding:8px;border:1px solid #9eb0bd;background:#fff;color:#172737;font:.7rem/1.5 inherit;resize:vertical}.ugn-reply-signature{position:relative;min-height:76px;border:1px dashed #8197a5;background:#fff;cursor:pointer;overflow:hidden}.ugn-reply-signature span{position:absolute;inset:0;display:grid;place-items:center;color:#657b88;font:700 .58rem Consolas,monospace}.ugn-reply-signature img{display:none;width:100%;height:100%;object-fit:contain}.ugn-reply-signature.signed img{display:block}.ugn-reply-signature.signed span{display:none}.ugn-reply-signature.signed::after{content:'최영호 · 전자서명';position:absolute;right:4px;bottom:2px;color:#416678;background:#ffffffd9;font:700 .47rem Consolas,monospace}.ugn-reply-actions{display:flex;align-items:center;gap:10px;margin-top:9px}.ugn-reply-actions .ugn-save-state{margin-right:auto}
